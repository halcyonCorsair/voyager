...
// StatusAdapter provides legacy status behavior for autowiring plugins.
//
// Deprecated: implement the Status() function directly.
type StatusAdapter func(resource *orch_v1.StateResource, context *WiringContext) (r *WiringResult, retriable bool, e error)

func (f StatusAdapter) WireUp(resource *orch_v1.StateResource, context *WiringContext) (r *WiringResult, retriable bool, e error) {
...
func (f StatusAdapter) Status(resource *orch_v1.StateResource, context *StatusContext) (*StatusResult, bool /*retriable*/, error) {
	resource2type2condition := newResourceConditionsFromResourceStatuses(resource.Name)
...
func newResourceConditionsFromResourceStatuses(bundle *smith_v1.Bundle) resourceConditions {
